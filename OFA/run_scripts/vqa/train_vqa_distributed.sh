...
# data_dir=../../dataset/vqa_data # ms
data_dir=/data/2_data_server/cv-07/dice/2025_samsung_challenge/dataset/VQA_v2
data=${data_dir}/generated_vqa_data_abcd/vqa_train.tsv,${data_dir}/generated_vqa_data_abcd/vqa_val.tsv # ms
