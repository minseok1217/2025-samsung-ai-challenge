...
class TransformerConfig(FairseqDataclass):
    ...
    model_param_type: str = field(
        default="", metadata={"help": "specify parameterization: edgeformer, ut; default is ''"}
    )
    ...
    lora_r: int = field(
        default=0, metadata={"help": "Rank r for LoRA. 0 means disabled."}
    )
    lora_r_shape: int = field(
        default=0, metadata={"help": "LoRA r for different layers. 0 means uniform, 1 means decrasing (2, 1.5, 1, 0.5 ...), 2 means increasing"}
    )
