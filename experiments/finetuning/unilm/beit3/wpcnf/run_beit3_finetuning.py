...
def get_args():
    ...
    parser.add_argument('--task', type=str, required=True, 
                        choices=['nlvr2', 'vqav2', 'flickr30k', 'coco_retrieval', 'coco_captioning', 'nocaps', 'imagenet', 'binary_classification', 'cross_entropy', 'language_model_tf', 'language_model_multichoice', 'LanguageModelMultiChoiceDataset'], 
...
def main(args, ds_init):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #     data_loader_train = create_downstream_dataset_only_train(args)
        ...
        if data_loader_val is not None:
            ...
            elif args.task in ["language_model_multichoice", "language_model_tf"]:
